...
class ToggleBinFillersAndTote(smach.State):
    def __init__(self, action='fill_bins'):
        ...
        self.action_ = action
        if self.action_ == 'fill_bins' or self.action_ == 'fill_bins_tote' or self.action_ == 'all_bins': srv_name = '/apc_grasping/fill_bins'
        ...
        if self.action_ == 'fill_bins' or self.action_ == 'fill_bins_tote' or self.action_ == 'all_bins':
    ...
    def execute(self, userdata):
        if self.action_ == 'fill_bins' or self.action_ == 'fill_bins_tote' or self.action_ == 'all_bins': return self.execute_fill_bins(userdata)
